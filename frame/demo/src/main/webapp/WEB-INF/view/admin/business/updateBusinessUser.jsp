    ...
    <table class="table table-striped table-bordered edit-table">
        ...
        <tr>
            ...
            <td><select name="isEnable">
                <option value="0" <c:if test="${bUserModel.isEnable == 0}">selected="selected"</c:if>>是</option>
                <option value="1" <c:if test="${bUserModel.isEnable == 1}">selected="selected"</c:if>>否</option>
            </select>
            </td>
            <td colspan="3">
            </td>
        ...
        <tr>
            ...
            <td><input name="facilitator_name" value="${cFacilitator.facilitator_name}" type="text"
                       nullmsg="请输入门店名称"/>
            </td>
            <td>门店地址<font color="FF0000">*</font>
            </td>
            <td><input name="facilitator_address" value="${cFacilitator.facilitator_address}" type="text"
                       nullmsg="请输入门店地址"/>
            </td>

            <td>门店联系人<font color="FF0000">*</font>
            </td>
            <td><input name="failitator_contacts" value="${cFacilitator.failitator_contacts}" type="text"
                       nullmsg="请输入门店联系人"/>
            </td>

            <td>门店电话<font color="FF0000">*</font>
            </td>
            <td><input name="failitator_phone" value="${cFacilitator.failitator_phone}" type="text"
                       nullmsg="请输入门店电话"/>
            </td>
