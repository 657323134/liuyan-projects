...
<div class="detail">
    <table>
        ...
        <tr>
            <td class="key"><strong>操作金额：</strong>
            </td>
            <td>${dtomsg.operAmount }</td>
            <td class="key"><strong>可用余额增加金额：</strong>
            </td>
            <td>
                ${dtomsg.inAmount }
            </td>
        ...
        <tr>
            <td class="key"><strong>可用余额减少金额：</strong>
            </td>
            <td>${dtomsg.outAmount }
            </td>
        ...
        <tr>
            <td class="key"><strong>项目名称：</strong>
            </td>
            <td>
                ${dtomsg.fundMode}
            </td>
            <td class="key"><strong>项目类型：</strong>
            </td>
            <td>
                ${dtomsg.fundType}
            </td>
        ...
        <tr>
            <td class="key"><strong>备注：</strong>
            </td>
            <td>
                ${dtomsg.remarks}
            </td>
            <td class="key"><strong>可用余额：</strong>
            </td>
            <td>
                ${dtomsg.usableAmount}
            </td>
        ...
        <tr>
            <td class="key"><strong>冻结金额：</strong>
            </td>
            <td>
                ${dtomsg.frozenAmount}
            </td>
            <td class="key"><strong>操作类型：</strong>
            </td>
            <td>
                <c:choose>
