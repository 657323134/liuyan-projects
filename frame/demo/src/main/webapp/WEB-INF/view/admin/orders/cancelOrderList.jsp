...
<form id="searchForm" action="tkCheckList">
                ...
                <c:choose>
                    <c:when test="${bean.auditStatus== 1}">
                        <input class="btn btn-inverse" type="button" value="通过"
                               onclick="goCheck('checkCancelOrderStatus','${bean.id}','2');"/>&nbsp;
                        <input class="btn btn-inverse" type="button" value="不通过"
                               onclick="goCheck('checkCancelOrderStatus','${bean.id}','3');"/>&nbsp;
                    </c:when>
