...
<form id="editForm" action="updateTPersonBorrower">
    <table class="table table-striped table-bordered edit-table">
        ...
        <tr>
            ...
            <td><input name="borrowerName" value="${tPersonBorrowerModel.borrowerName }" type="text"
                       datatype="s2-20" nullmsg="请输入借款人姓名" errorMsg="借款人姓名长度为2-20位"/>
            </td>
            <td>借款人身份证<font color="FF0000">*</font>
            </td>
            <td><input id="borrowerIdCard" name="borrowerIdCard" value="${tPersonBorrowerModel.borrowerIdCard }"
                       type="text"
                       datatype="idcard" nullmsg="请填写借款人身份证" errorMsg="借款人身份证格式不正确"/></td>
            <td>借款人手机号<font color="FF0000">*</font>
            </td>
            <td><input id="borrowerCellPhone" name="borrowerCellPhone"
                       value="${tPersonBorrowerModel.borrowerCellPhone }" type="text"
        ...
        <tr>
            ...
            <td><input name="maritalStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="maritalStatus" type="radio" value="0"/>否&nbsp;<input name="maritalStatus" type="radio"
                                                                               value="1"/>是
            </td>
        ...
        <tr>
            ...
            <td><input name="childrenStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="childrenStatus" type="radio" value="0"/>否&nbsp;<input name="childrenStatus" type="radio"
                                                                                value="1"/>是
            </td>
            <td>是否有房<font color="FF0000"></font>
            </td>
            <td><input name="houseStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input name="houseStatus"
                                                                                                   type="radio"
                                                                                                   value="0"/>否&nbsp;<input
                    name="houseStatus" type="radio" value="1"/>是
            </td>
            <td>是否有车<font color="FF0000"></font>
            </td>
            <td><input name="houseStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input name="carStatus"
                                                                                                   type="radio"
                                                                                                   value="0"/>否&nbsp;<input
                    name="carStatus" type="radio" value="1"/>是
            </td>
        </tr>
        <tr>
            ...
            <td colspan="5">
                ...
                <select id="monthlyIncomeLevel" name="monthlyIncomeLevel" datatype="*" ignore="ignore"
                        nullmsg="请选择工作省份">
                    <option value="">--请选择--</option>
        ...
        <tr>
            ...
            <td colspan="3">
                <input id="position" name="position" value="${tJobBorrowerModel.position }" type="text"/></td>
        </tr>
        <tr>
            <td>借款人介绍<font color="FF0000">*</font></td>
            <td colspan="3"><textarea rows="3" id="borrowpersonImg" name="borrowpersonImg"
                                      cols="100" style="width: 80%" datatype="*"
                                      nullmsg="请输入借款人介绍">${tPersonBorrowerModel.borrowpersonImg }</textarea>
            </td>
        </tr>
        </tbody>
        <tfoot>
...
<script type="text/javascript">
    ...
    var valiForm = $("#editForm").Validform({
        ...
        beforeCheck: function (curform) {
            ...
            $("#borrowpersonImg").val(editor.document.getBody().getHtml());
        },
        postonce: true,
        ajaxPost: true,
    ...
    $.Tipmsg.r = "";
    editor = CKEDITOR.replace('borrowpersonImg', {
