...
<!--右边框架开始-->
<div class="crumbs">
    当前位置<b class="tip"></b>添加角色
</div>
<form id="editForm" action="addBRole">
    <table class="table table-striped table-bordered edit-table">
        ...
        <tr>
            ...
            <td colspan="3"><input name="roleName" value="" type="text"
                                   datatype="s2-10" nullmsg="请输入角色名称" errorMsg="角色名称长度为2-10位"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="3"><textarea name="description" style="width: 95%"
                                      ...
                                      errorMsg="角色描述长度为2-50位"></textarea></td>
                    ...
                    <c:forEach items="${menuList }" var="bean">
                        <c:if test="${parent.id ==bean.parentId}">
                            <input class="top_${parent.id} parent" name="menuId"
                                   parentId="${bean.parentId }" type="checkbox"
                                   value="${bean.id }"/>${bean.menuName }
                        </c:if>
                    </c:forEach>
                    <br/>
                </c:if>
        ...
        <tr>
            <td colspan="4"><input class="btn btn-inverse" id="btnSave"
                    ...
                    onclick="goUrl('queryBRoleList')" value="返回"/>&nbsp;&nbsp;<span
