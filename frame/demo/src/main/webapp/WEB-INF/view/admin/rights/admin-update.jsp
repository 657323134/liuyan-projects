...
<form id="editForm" action="updateBAdmin">
    <table class="table table-striped table-bordered edit-table">
        <thead>
        <tr>
            <td colspan="4"><b>基本信息</b> <input id="id" name="id" value="${bAdminModel.id }" type="hidden"/>
            </td>
        </tr>
        </thead>
        <tbody>
        <tr>
            ...
            <td>
                <input name="adminName" value="${bAdminModel.adminName }" type="text" datatype="s5-20" ignore="ignore"
                       nullmsg="请输入管理员用户名" errorMsg="管理员用户名长度为5-20位"/>
            </td>
            <td>是否禁用<font color="FF0000">*</font></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input name="pwd" value="" type="password" datatype="*6-18" ignore="ignore" nullmsg="请输入密码"
                       errorMsg="密码长度为6-18位"/>
            </td>
            <td>确认密码<font color="FF0000">*</font></td>
            <td>
                <input name="confirmPwd" value="" type="password" datatype="*" ignore="ignore" recheck="pwd"
