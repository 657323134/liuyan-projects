...
<form id="searchForm" action="queryTRechargeList">
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            ...
            <td>审核状态</td>
            <td>
                <select name="result" id="isEnable" class="isEnableCls">
        ...
        <tr>
            <td colspan="8" align="right">
                ...
                <input class="btn btn-inverse" onclick="exportForm('exportTRechargeList')" type="button" value="导出"/>
            </td>
        </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <td>
                <input class="btn btn-inverse" type="button" value="查看"
                       onclick="goUrl('queryTRechargeListDetailed?id=${bean.id}');"/>&nbsp;
            </td>
        </tr>
    </c:forEach>
