    ...
    <table class="table table-striped table-bordered edit-table">
        ...
        <tr>
            <td colspan="4"><b>基本信息</b>
                <input id="id" name="id" value="${bParaModel.id }" type="hidden"/>
            </td>
        </tr>
        </thead>
        <tbody>
        <tr>
            ...
            <td>
                <input name="paraName" value="${bParaModel.paraName }" type="text" datatype="s2-20" nullmsg="请输入参数名称"
                       errorMsg="参数名称长度为2-20位"/>
            </td>
            <td>参数编码<font color="FF0000">*</font></td>
            <td>
                <input name="paraCode" value="${bParaModel.paraCode }" type="text" datatype="s2-20" nullmsg="请输入参数编码"
        ...
        <tr>
            ...
            <td>
                <input name="paraKey" value="${bParaModel.paraKey }" type="text" datatype="*1-20" nullmsg="请输入参数键"
                       errorMsg="参数键长度为1-20位"/>
            </td>
            <td>参数值<font color="FF0000">*</font></td>
            <td>
                <input name="paraValue" value="${bParaModel.paraValue }" type="text" datatype="*1-30" nullmsg="请输入参数值"
                       errorMsg="参数值长度为1-30位"/>
            </td>
        </tr>
        <tr>
            <td>是否隐藏<font color="FF0000">*</font></td>
            <td colspan="3">
                <select name="isDelete" class="isDeleteCls">
