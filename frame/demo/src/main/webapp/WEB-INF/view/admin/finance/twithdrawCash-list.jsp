...
<form id="searchForm" action="queryTWithdrawCashList">
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            ...
            <td>提现状态</td>
            <td>
                <select name="withdrawStatus" id="isEnable" class="isEnableCls">
        ...
        <tr>
            <td colspan="8" align="right">
                ...
                <input class="btn btn-inverse" onclick="exportForm('exportTWithdrawCashList')" type="button"
                       value="导出"/>
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            ...
            <td>
                <input class="btn btn-inverse" type="button" value="查看"
                       onclick="goUrl('selectTWithdrawCashDeatil?id=${bean.id}');"/>&nbsp;
                <c:if test="${bean.withdrawStatus ==1}">
