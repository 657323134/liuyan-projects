    ...
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            ...
            <td class="detail" colspan="5">
                <input id="roleName" name="roleName" type="text" value="${model.roleName }"/>
            </td>
        </tr>
        <tr>
            <td colspan="6" align="right">
                ...
                <input class="btn btn-inverse" type="button" onclick="goUrl('addBRoleIndex')" value="添加"/>&nbsp;
            </td>
        </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <td>
                <input class="btn btn-inverse" type="button" value="修改"
                       onclick="goUrl('updateBRoleIndex?id=${bean.id}');"/>&nbsp;
                <input class="btn btn-inverse" type="button" value="查看"
                       onclick="goUrl('queryBRoleIndex?id=${bean.id}');"/>&nbsp;
            </td>
        </tr>
    </c:forEach>
