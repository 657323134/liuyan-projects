...
<div class="input-box user-data reg-input">
    ...
    <button onclick="window.location.href='/demoshow/register.htm'">注册会员</button>
</div>

<div class="tip-login">
    <p>已有平台账号？<a href="">立即登录</a></p>
</div>
...
<script>
    ...
    function userRegister() {
        ...
        $.ajax({
            url: '/cuser/userCheck',
            type: 'POST',
            data: {cellPhone: cellPhone, validateCode: validateCode, cardid: cardid},
            success: function (msg) {
                if (msg.status == 'success') {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {openid: openid, cellPhone: cellPhone, realName: realName, cardid: cardid},
                        success: function (msg) {
                            console.log(msg);
                            if (msg.status == 'success') {
