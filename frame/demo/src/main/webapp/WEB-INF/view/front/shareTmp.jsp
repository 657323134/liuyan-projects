...
//        alert(url + "/html/view/front/share.html?buserid=" + buserid+"&goodsid="+goodsid);

        window.location.href = url + "/html/view/front/share.html?buserid=" + buserid+"&goodsid="+goodsid;
    }
</script>
</html>
