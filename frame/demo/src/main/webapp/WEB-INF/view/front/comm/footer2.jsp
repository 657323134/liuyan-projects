...
<div id="foot">
    <div class="foot_main">
        ...
        <div class="fo_mtxt clearfix">
            <div class="fo_left">
                <p class="fo_links">
                    <a href="aboutus.html">关于微品金融</a><a href="helpInfo.html">帮助中心</a><a
                        href="safe.html">安全保障</a><a href="platformPrinciple.html">平台原理</a><a href="showCertificate.html"
                                                                                             target="_blank">资金托管商户认证</a>
        ...
        <!--copy start-->
        <div class="foot_copy">
            微品金融互联网金融平台 <a class="fcopy_site" href="https://www.vpfinance.com/">(
            www.vpfinance.com )</a> 版权所有 <a class="fcopy_beian"
                                            href="http://www.miitbeian.gov.cn/publish/query/indexFirst.action"
                                            target="_blank">粤ICP备16073355号-2</a>
        </div>
        <!--copy end-->
        <!--证书 start-->
    ...
    <div class="pnav_box pnav_box2">
        ...
        <div class="nav_kefu">
            <div class="kefu_box kefu_a">
                ...
                <p class="kefu_txt">
                    全国服务热线：<br/> <span class="kefu_tel">400-876-9008</span>
                </p>
            </div>
