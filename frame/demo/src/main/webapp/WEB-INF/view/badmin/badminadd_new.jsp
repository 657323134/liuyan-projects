...
<div class="layui-container">
    ...
    <form method="post" action="/bAdmin/bAdminAddSave">
        <div class="layui-form-item">
            <div class="layui-inline">
                <!--ID--><label class="layui-form-label"><spring:message code="badmin.id"/></label>
                <div class="layui-input-inline" style="width: 140px;">
                    <input type="text" name="id" placeholder="<spring:message  code='badmin.id'/>" id="bAdmin.id"
                           placeholder="<spring:message  code='badmin.id'/>"
                           autocomplete="off" class="layui-input"><bean:message key="validation.required"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:300px">
                <input type="text" name="adminName" id="bAdmin.adminName" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:300px">
                <input type="text" name="pwd" id="bAdmin.pwd" lay-verify="required"
                       placeholder="<spring:message  code='badmin.pwd'/>"
                       maxlength="32" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <!--创建时间--><label class="layui-form-label"><spring:message code="badmin.createTime"/></label>
            <div class="layui-input-inline" style="width: 140px;">
                <input type="text" name="createTime" id="bAdmin.createTime" placeholder="YYYY-MM-DD" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 140px;">
                    <input type="text" name="isEnable" placeholder="<spring:message  code='badmin.isEnable'/>"
                           id="bAdmin.isEnable"
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="demo2"><spring:message
