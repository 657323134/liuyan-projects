...
(function () {
    ...
    (function () {
        ...
        a.nd = "\154\x6f";
        a.jG = "\150\157";
        a.hf = new window["\122\145\147\x45\170\x70"]("\136\167\x77\167\x5c\056");
            ...
            bM: [], bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\x40\x74\150\165\155\142\x73\105\x6e\x61\x62\x6c\x65\144").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\x40\164\150\165\155\142\x73\x55\162\x6c");
                            if (u)q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\x40\x74\x68\165\x6d\142\163\104\151\162\145\143\x74\x41\x63\143\145\x73\x73");
                            if (u)q.config.thumbsDirectAccess = u.value == 'true';
                            u = t.selectSingleNode(v + "\x40\x74\150\165\x6d\x62\163\x57\151\x64\164\150");
                            q.config.thumbsWidth = (u ? parseInt(u.value, 10) : 100) || 100;
                            u = t.selectSingleNode(v + "\x40\x74\150\x75\x6d\x62\x73\x48\x65\x69\147\150\164");
                            q.config.thumbsHeight = (u ? parseInt(u.value, 10) : 100) || 100;
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\100\151\155\x67\127\151\x64\164\150").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\100\151\x6d\147\x48\145\151\147\150\164").value, 10);
                        u = t.selectSingleNode(v + "\x40\x75\x70\x6c\x6f\141\x64\x4d\141\170\123\151\x7a\145");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\x40\x75\x70\x6c\x6f\x61\144\103\150\145\143\x6b\111\155\141\147\145\163");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\100\160\x6c\x75\x67\x69\156\x73"), x = w && w.value;
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\x63\x61\164\x69\x6f\156"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))setTimeout(function () {
                                A.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], v = ['Node', "\155\145\163\x73\x61\x67\x65"];
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\143\141\164\151\157\156"][a.jG + "\x73\164"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        function z() {
    ...
    (function () {
                    ...
                    if (y == 'mouseup') {
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                ...
                                }), J = window.top[a.nd + "\143\x61\164\x69\157\156"][a.jG + "\163\x74"], K = new a.iD(x.app, 'moveFilesToFolderDrop', {
        ...
        p.prototype = {
            iW: function (r) {
                ...
                this.jr = r;
                if (this.jr instanceof k)this.flm.focus();
            }, vE: function () {
                return this.jr;
            }, kz: function (r) {
                this.kP = r;
    ...
    (function () {
        ...
        m.add('basket', {
            ...
            bz: function v(q) {
                var r = window.top[a.nd + "\x63\141\x74\x69\x6f\156"][a.jG + "\x73\164"], s = [], t = function () {
                ...
                q.bD('FolderPasteMoveBasket', {
                    exec: function (w) {
                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(r) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))w.msgDialog('', "\124\x68\x69\x73\040\x66\165\156\143\164\151\x6f\x6e\x20\151\x73\x20\x64\151\163\141\142\154\145\x64\x20\x69\156\040\x74\x68\145\040\x64\145\x6d\157\040\x76\145\x72\163\x69\157\x6e\x20\157\x66\040\103\x4b\x46\x69\x6e\x64\145\x72\056\x3c\x62\162\040\057\x3e\x50\154\145\141\x73\145\x20\x76\x69\163\x69\x74\x20\x74\x68\145\040\x3c\x61\040\150\x72\145\146\x3d\047\x68\x74\164\160\x3a\x2f\057\x63\153\x73\x6f\x75\162\143\145\056\x63\x6f\155\057\x63\x6b\146\151\156\x64\145\162\x27\076\x43\113\106\x69\156\x64\145\x72\x20\x77\145\x62\x20\x73\x69\164\145\074\057\141\x3e\x20\164\x6f\x20\157\142\164\x61\x69\x6e\040\x61\040\x76\x61\x6c\x69\144\x20\154\151\x63\145\156\x73\145\056"); else {
                            var x = w.aV;
                            if (!x)return;
        ...
        a.application.layout.prototype = {
            ea: function (v) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\141\164\x69\157\x6e"][a.jG + "\x73\x74"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(), B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\x6f\x73\151\164\x69\x6f\x6e") == "\163\x74\141\164\151\143")B = 1;
                        }
                        if (!B)this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\142\x3e" + i.htmlEncode(a.ed) + "\x3c\x2f\x62\x3e\074\057\x64\x69\166\x3e");
                    }
