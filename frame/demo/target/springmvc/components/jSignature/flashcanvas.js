...
window.ActiveXObject && !window.CanvasRenderingContext2D && function () {
    ...
    var G = this.document, t = "canvas", C = "FlashCanvas", H = "onreadystatechange", n;
    a:{
        n = this.document.getElementsByTagName("script");
        var I = "",
            u = n.length;
        if (u)for (I = n[u - 1].src || ""; u;) {
            script = n[u - 1];
    ...
    var K = n.replace(/[^\/]+$/, ""), e = new function (a) {
    ...
    w.prototype = {
        save: function () {
            ...
            if (this._strokeStyle !== this.strokeStyle) {
                ...
                if ("string" !== typeof a)if (a instanceof r || a instanceof z)a = a.id; else return;
            ...
            a || i(17);
            var c = a.tagName, d, f = this._canvasId;
            if (c)if (c = c.toLowerCase(), "img" === c)d = a.getAttribute("src", 2); else {
        ...
        fill: function () {
            ...
            if (this._font !== this.font)try {
                ...
                var c = b.currentStyle, d = [c.fontStyle, c.fontWeight, b.offsetHeight,
                    c.fontFamily].join(" ");
                a.push(e.font, d)
            } catch (f) {
            }
            ...
            a || i(17);
            var h = a.tagName, k, l = arguments.length,
                A = this._canvasId;
            if (h)if (h = h.toLowerCase(), "img" === h)k = a.getAttribute("src", 2); else {
            ...
            this._setShadows();
            k = s(k);
            if (3 === l)this._queue.push(e.drawImage, l, k, b, c); else if (5 === l)this._queue.push(e.drawImage, l, k, b, c, d, f); else if (9 === l)(0 === d || 0 === f) && i(1), this._queue.push(e.drawImage, l, k, b, c, d, f, g, j, M, N); else return;
        ...
        putImageData: function () {
            ...
            var d = a.tagName, f, g = this._canvasId;
    ...
    E.prototype = Error();
    var J = "initElement", m = {
        registeredEvents: {}, canvases: {}, initWindow: function (a) {
            function b() {
            ...
            var d = this.canvases, e = this.registeredEvents, g = function () {
                a.detachEvent("onunload", g);
                var b, c, h, k, l, j, B;
                for (B in d)if (b = d[B], c = b.firstChild, k = b.ownerDocument.defaultView ? b.ownerDocument.defaultView : b.ownerDocument.parentWindow, a === k) {
    ...
    m[J] = function (a) {
        ...
        var b = a.ownerDocument, c = b.defaultView ? b.defaultView : b.parentWindow;
        c.CanvasRenderingContext2D || this.initWindow(c);
        var d = Math.random().toString(36).slice(2) || "0", f = "external" + d;
        v[d] = !1;
        p[d] = {};
        q[d] = 1;
        x[d] = {};
        ...
        if (i(a))j.movie = g; else var m = c.setInterval(function () {
        ...
        b = function (a) {
            var a = a ? a.srcElement : c.event.srcElement, b = a.parentNode;
            a.blur();
            b.focus()
        };
    ...
    m.unlock = function (a, b, c) {
        try {
            ...
            if (void 0 === b)d = this.canvases[a], e = d.firstChild, k = d.ownerDocument, l = k.defaultView ? k.defaultView : k.parentWindow, F(d), g = d.width, j = d.height, d.style.width = g + "px", d.style.height = j + "px", 0 < g && (e.width = g), 0 < j && (e.height = j), e.resize(g, j), b = function (a) {
                var a = a ? a : l.event, b = a.propertyName;
                if ("width" === b || "height" === b) {
                    var a = a.srcElement, c = a[b], d = parseInt(c, 10);
                ...
                d.onload()
            }, 0); else if (i = x[a][b])m = i[0], h = i[1 + c], delete x[a][b], "function" === typeof h && h.call(m);
            q[a] && --q[a]
        } catch (n) {
