...
<div class="page__bd">
    <h1 class="page__title">优卡分期还款端</h1>
    ...
    <div class="login-panel">
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="number" id="phone" pattern="[0-9]*" placeholder="请输入手机号"
                           value="15508374923"/>
                </div>
            </div>
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="tel" placeholder="请输入验证码" id="smsCode" value="287465">
                </div>
        ...
        <a class="weui-btn ui-btn_primary" id="loginBtn" href="/demoshow/repayIndex.htm">登录</a>
