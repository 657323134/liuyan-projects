...
<form id="editForm" action="updateCUser">
    <div class="detail">
        <table class="table table-striped table-bordered table-condensed">
            ...
            <tr>
                <td class="key"><strong>用户名：</strong></td>
                <td>${cUserModel.userName }</td>
                <td class="key"><strong>手机号码：</strong></td>
                <td>${cUserModel.cellPhone }</td>
            </tr>
            <tr>
                <td class="key"><strong>邮箱地址：</strong></td>
                <td colspan="3">${cUserModel.email }</td>
            </tr>
            <tr>
                <td class="key"><strong>用户来源：</strong>
                </td>
                ...
                <td class="key"><strong>是否禁用：</strong>
                </td>
            ...
            <tr>
                <td class="key"><strong>创建时间：</strong>
                </td>
                <td><fmt:formatDate value="${cUserModel.createTime}"
                                    pattern="yyyy-MM-dd HH:mm:ss"/></td>
                <td class="key"><strong>注册IP：</strong></td>
                <td>${cUserModel.regIp}</td>
            </tr>
            <tr>
                <td class="key"><strong>最后登录IP：</strong></td>
                <td>${cUserModel.lastLoginIp}</td>
                <td class="key"><strong>最后登录时间：</strong></td>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <tr>
                        <td class="key"><strong>真实姓名：</strong>
                        </td>
                    ...
                    <tr>
                        <td class="key"><strong>实名时间：</strong>
                        </td>
                        <td><fmt:formatDate value="${cUserModel.pcreateTime}"
                                            pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        <td class="key"><strong>身份证号：</strong>
                        </td>
            ...
            <tr>
                <td colspan="4"><input class="btn btn-inverse" id="btnSave"
                                       type="button" value="修改"/> &nbsp;<input class="btn btn-inverse"
                                                                               id="btnBack" type="button"
                                                                               onclick="goUrl('queryCUserList')"
                                                                               value="返回"/>&nbsp;&nbsp;<span
                        id="errorMsg"
