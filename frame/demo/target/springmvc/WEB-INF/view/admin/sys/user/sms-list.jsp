...
<form id="searchForm" action="queryCSmsList">
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            ...
            <td>真实姓名</td>
            <td class="detail">
                <input width="100px;" id="realName" name="realName" type="text" value="${model.realName }"/>
            </td>
            <td>手机号码</td>
            <td class="detail">
            ...
            <td>发送状态</td>
            <td>
                <select name="sendStatus" id="sendStatus" class="issendStatus">
        ...
        <tr>
            ...
            <td>
                <c:choose>
                    ...
                    <c:when test="${bean.sendStatus==3 }">发送失败</c:when>
                </c:choose>
            </td>
            <td>
