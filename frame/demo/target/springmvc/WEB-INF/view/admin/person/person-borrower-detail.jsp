...
<div class="detail">
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tr>
            <td width="10%" align="right" valign="top" class="key"><strong>借款人姓名：</strong>
            </td>
            <td width="20%" valign="top">${tPersonBorrowerModel.borrowerName }</td>
            <td width="10%" align="right" valign="top" class="key"><strong>借款人身份证：</strong>
            </td>
            <td width="20%" valign="top">${tPersonBorrowerModel.borrowerIdCard }</td>
            <td width="10%" align="right" valign="top" class="key"><strong>借款人手机号：</strong>
            </td>
            <td width="20%" valign="top">${tPersonBorrowerModel.borrowerCellPhone }</td>
        </tr>
        <tr>
            <td class="key"><strong>户籍：</strong></td>
            ...
            <td class="key"><strong>性别：</strong>
            </td>
            <td valign="top"><input name="sex" type="radio" value="1"/>男&nbsp;<input name="sex" type="radio" value="2"/>女
            </td>
            <td class="key"><strong>是否结婚：</strong>
            </td>
            <td valign="top"><input name="maritalStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="maritalStatus" type="radio" value="0"/>否&nbsp;<input name="maritalStatus" type="radio"
                                                                               value="1"/>是
            </td>
        </tr>
        <tr>
            <td class="key"><strong>是否有孩子：</strong>
            </td>
            <td valign="top"><input name="childrenStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="childrenStatus" type="radio" value="0"/>否&nbsp;<input name="childrenStatus" type="radio"
                                                                                value="1"/>是
            </td>
            <td class="key"><strong>是否有房：</strong>
            </td>
            <td valign="top"><input name="houseStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="houseStatus" type="radio" value="0"/>否&nbsp;<input name="houseStatus" type="radio" value="1"/>是
            </td>
            <td class="key"><strong>是否有车：</strong>
            </td>
            <td valign="top"><input name="houseStatus" type="radio" value="2" checked="checked"/>未知&nbsp;<input
                    name="carStatus" type="radio" value="0"/>否&nbsp;<input name="carStatus" type="radio" value="1"/>是
            </td>
        </tr>
        <tr>
            <td class="key"><strong>月收入水平：</strong>
            </td>
        ...
        <tr>
            <td class="key"><strong>工作城市：</strong>
            </td>
            ...
            <td class="key"><strong>工作年限：</strong>
            </td>
            ...
            <td class="key"><strong>公司行业：</strong>
            </td>
        ...
        <tr>
            <td class="key"><strong>公司性质：</strong>
            </td>
            ...
            <td class="key"><strong>岗位或职位：</strong>
            </td>
            <td valign="top" colspan="3">${tJobBorrowerModel.position }</td>

        </tr>
        <tr>
            <td class="key"><strong>借款人介绍：</strong>
            </td>
            <td colspan="3" valign="top">${tPersonBorrowerModel.borrowpersonImg}
            </td>
