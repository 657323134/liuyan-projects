...
<div class="detail">
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tr>
            ...
            <td class="key"><strong>提现金额：</strong>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="key"><strong>手续费：</strong>
            </td>
            <td>
                ${twmsg.feeAmount }
            </td>
        ...
        <tr>
            ...
            <td class="key"><strong>提现状态：</strong>
            </td>
            <td>
                <c:choose>
        ...
        <tr>
            <td class="key"><strong>银行卡号：</strong>
            </td>
            <td>
                ${twmsg.bankCardId }
            </td>
            <td class="key"><strong>处理人ID：</strong>
            </td>
            <td>
                ${twmsg.adminId }
            </td>
