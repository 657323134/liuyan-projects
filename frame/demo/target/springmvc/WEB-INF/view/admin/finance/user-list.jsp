    ...
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            <td colspan="6" align="right">
                ...
                <input class="btn btn-inverse" onclick="exportForm('exportSelectUserList')" type="button" value="导出"/>
            </td>
        </tr>
        </tbody>
    </table>
...
<table class="table table-striped table-bordered table-hover" id="top">
    ...
    <c:forEach items="${pageBean}" var="bean" varStatus="st">
        <tr>
            ...
            <td>
                <input class="btn btn-inverse" type="button" value="查看" onclick="openUserFundrecord('${bean.id}');"/>&nbsp;
            </td>
        </tr>
    </c:forEach>
