...
<form id="searchForm" action="queryBAdminList">
    <table class="table table-striped table-bordered search-table">
        ...
        <tr>
            <td>管理员用户名</td>
            <td class="detail">
                <input id="adminName1" name="adminName" type="text" value="${model.adminName }"/>
            </td>
            <td>是否禁用</td>
            <td colspan="3">
        ...
        <tr>
            <td colspan="6" align="right">
                ...
                <input class="btn btn-inverse" type="button" onclick="goUrl('addBAdminIndex')" value="添加"/>&nbsp;
            </td>
        </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <td>
                <input class="btn btn-inverse" type="button" value="修改"
                       onclick="goUrl('updateBAdminIndex?id=${bean.id}');"/>&nbsp;
                <input class="btn btn-inverse" type="button" value="查看"
                       onclick="goUrl('queryBAdminIndex?id=${bean.id}');"/>&nbsp;
                <input class="btn btn-inverse" type="button" value="分配权限"
