...
<div class="page__bd add-product1 addProduct1">
    ...
    <div class="weui-cells weui-cells_form">
        ...
        <div class="weui-cell weui-cell_select weui-cell_select-after">
            ...
            <div class="weui-cell__bd">
                <select class="weui-select goodsType1" name="select2" id="selectGoodsType1" onchange="changeGoodsType(1)">
        ...
        <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
                <p><input class="weui-input priceClass" data-price="1" type="number" name="price1" value="${tGoods.goodsprice}"/></p>
            </div>
        </div>
        <div class="weui-cell">
        ...
        <div class="weui-cells weui-cells_form">
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    ...
                    <input type="text" class="weui-input" placeholder="请输入车牌号" oninput="this.value=this.value.toUpperCase()" size="11" name="car_num" id="car_num" style="width: 60%;" value="">
                </div>
            </div>
        </div>
    </div>
...
//            html += ' </div>';
        ...
        html += '<div class="weui-cell__hd"><label class="weui-label">设备号1</label></div>'
                ...
                + '<div class="sim-box">'
                + '<div class="sim-box-left">'
                + '<input class="weui-input priceClass" data-sim="1" type="text" oninput="this.value=this.value.toUpperCase()" name="simNo' + index + '" placeholder=\"请输入SIM卡号\"/>'
                + '</div>'
                + '<div class="sim-box-img"  id="scanSimImg'+index+''+1+'" onclick="scanImgBtn(this.id)">'
                + '<img src="/images/businesses/scan-icon.png"/>'
                + '</div>'
                + '</div>'
                + '<div class="ime-box">'
                + '<div class="ime-box-left">'
                + '<input class="weui-input priceClass" data-imei="1" type="text" oninput="this.value=this.value.toUpperCase()" name="imeiNo' + index + '" placeholder="请输入IMEI卡号"/>'
                + '</div>'
                + '<div class="ime-box-img" id="scanImeImg'+index+''+1+'" onclick="scanImgBtn(this.id)">'
                + '<img src="/images/businesses/scan-icon.png"/>'
                + '</div>'
                + '</div>'
                + '</div>'
    ...
    $('#createCode').click(function () {
        ...
        var carCodeArea = $("#carCodeArea").html() + $('#car_num').val().toLocaleUpperCase();
        if (totalPrice > 8000) {
            alert("货款总额不能超过8000");
            return false;
        }
...
//                }
            ...
            //sim及imei卡对应关系。
            var goodType =  $("#selectGoodsType"+i).val();
            if(goodType == 2){
                isRelation = true;
...
function sourceChange(index) {
    ...
    if (sourceType == 2) {
        ...
        html1 += "<option value='-3'>汽车美容</option>";
