...
<div class="page__bd add-product1 addProduct1">
    ...
    <div class="weui-cells weui-cells_form">
        ...
        <%--<div class="weui-cell weui-cell_select weui-cell_select-after">--%>
            ...
            <%--</div>--%>
            <%--<div class="weui-cell__bd">--%>
                <%--<select class="weui-select planSelect1" onchange="changePlan(1)"  >--%>
                    <%--<option value="-100">请选择金融方案</option>--%>
                    <%--&lt;%&ndash;<c:forEach items="${tFinancialPlans}" var="plan">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<option value="${plan.id}">${plan.name}</option>&ndash;%&gt;--%>
...
//        $(".planSelect1").attr("disabled", true);
        ...
        function chengeNum(ele){
            ...
            var html = "";
            html +=    '        <div class="card-id-box weui-cell">';
            html +=    '            <div class="weui-cell card-id">';
            html +=    '                <div class="weui-cell__hd"><label class="weui-label">设备号'+num+'</label></div>';
            html +=    '                <div class="weui-cell__bd">';
            html +=    '                    <input class="weui-input priceClass" data-sim="1" type="text" oninput="this.value=this.value.toUpperCase()" name="priceSIM'+index+'" placeholder="请输入SIM卡号"/>';
            html +=    '                    <input class="weui-input priceClass" data-imei="1" type="text" oninput="this.value=this.value.toUpperCase()" name="priceIMEI'+index+'" placeholder="请输入IMEI卡号"/>';
            html +=    '                </div>';
            html +=    '            </div>';
            html +=    '        </div>';
            ele.parents('.weui-cell').siblings('.card-id-box').html(html);
        }
...
//            html += ' </div>';
            ...
            html +=    '            <div class="weui-cell__bd">';
            html +=    '                <div class="select-num">';
            html +=    '                    <span class="subtract">一</span>';
            html +=    '                    <input data-num="1" type="number" name="goodNumber'+index+'" value="1" disabled/>';
            html +=    '                    <span class="add">十</span>';
            html +=    '                </div>';
            html +=    '            </div>';
            html +=    '        </div>';
