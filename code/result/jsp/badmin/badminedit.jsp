...
<div class="layui-container">
    ...
    <form class="layui-form layui-form-pane" action="/bAdminEditSave">
        <hidden name="bAdminForm" property="bAdmin.id"/>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 140px;">
                            <input type="text" name="bAdmin.id"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px">
                        <input type="text" name="bAdmin.adminName" id="bAdmin.adminName"
                               lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:300px">
                        <input type="text" name="bAdmin.pwd" id="bAdmin.pwd"
                               lay-verify="required"
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="width: 140px;">
                            <input type="text" name="bAdmin.isEnable"
